...
public class sqlconnectionajadb {
      ...
      rp.LoadProperties(driver);
	          ...
	          try {
	        	 ...
	        	 /* Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");  */
	        	  ...
	        	  return conn = DriverManager.getConnection(rp.getPropertyValue("aja_DB_URL"),rp.getPropertyValue("DB_USERNAME"),rp.getPropertyValue("DB_PASSWORD"));
	          }
